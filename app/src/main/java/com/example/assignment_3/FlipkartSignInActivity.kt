...
class FlipkartSignInActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_flipkart_sign_in)

        val nameEditText = findViewById<EditText>(R.id.editTextText5)
